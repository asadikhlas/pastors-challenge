		...
		<div className='App'>
			<div className='inner'>
				<Button
					...
					onClick={handleShowAllContactModal}
				>
					All Contacts
				</Button>
			...
			<Modal
				size='lg'
				show={isShowAllContactModal}
				onHide={() => setShowAllContactModal(false)}
			...
			>
				...
				<div className='btn-groups'>
					...
					<Button
						...
						onClick={handleShowUsContactModal}
					>
						US Contacts
					</Button>
					<Button
						className='close-btn btn'
						onClick={() => setShowAllContactModal(false)}
					>
						Close
					</Button>
				</div>
			...
			<Modal
				size='lg'
				show={isShowUsContactModal}
				onHide={() => setShowUsContactModal(false)}
				aria-labelledby='contained-modal-title-vcenter'
				centered
			>
				<Modal.Body>
				...
				<div className='btn-groups'>
					...
					<Button
						className='close-btn btn'
						onClick={() => setShowUsContactModal(false)}
					>
						Close
					</Button>
				</div>
